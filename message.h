...
#define CT_SFAILURE 400 //mensagem com informação de endereço_ip:porta do switch que falhou
#define CT_SRUNNING 500 //mensagem com informação de endereço_ip:porta do novo switch
